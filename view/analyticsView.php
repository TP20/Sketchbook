...
<link rel ="stylesheet" href ="../css/vidPage.css">
    ...
    <link rel ="stylesheet" href ="../css/analyticView.css">
        ...
        <div  id="custom-navbar" style="position: fixed; top: 5.5rem; width: 20rem;">
           <div class="col-sm-12">
            ...
            <div class="col-sm-12">
             ...
             <div class="col-sm-12">
                <div class="col-sm-12 custom-navbar-tabs" onclick="location.href ='analyticsView.php?logout=true'">
                    <div class="col-sm-12 custom-navbar-text">
...
<div class="col-sm-5 imageSection">
        <!--<div class="col-sm-12" > -->
            <div class="col-sm-12 imageModal">
                <h2 style="text-align:center; color:white">Please select an Image</h2>
            <?php
                ...
                Pictures::displayUserUploaded_Analytics($_GET['username']);
            ?>
        </div>
    </div>
<div id="analyticView-section">
    <div class="col-sm-5" id="pixlrFrame" frameborder="0">
    <?php

            
        if (isset($_GET['title'])) {
    #        echo "<iframe src='https://localhost//VidTube_organize_local/view/graphView.php?title=".$_GET['title']."&image2=".$_GET['image2']."' frameborder='0' width='100%' height='100%' scrolling='no' onload='resizeIframe(this)' ></iframe>";
       // echo "<iframe style='width: 70rem; height: inherit;' src='https://localhost//VidTube_organize_local/view/graphView.php?title=".$_GET['title']."&image2=".$_GET['image2']."' onload='resizeIframe(this)' frameborder='0'  scrolling='no'  ></iframe>";
        echo "<iframe style='width: 70rem; height: inherit;' src='https://localhost//VidTube_organize_local/view/graphView.php?title=".$_GET['title']."&image2=".$_GET['image2']."' onload='resizeIframe(this)' frameborder='0'  scrolling='no'  ></iframe>";
 
    }    
        else {
            #echo "<iframe src='https://localhost//VidTube_organize_local/view/graphView.php' frameborder='0' width='100%' height='100%' scrolling='no' onload='resizeIframe(this)' ></iframe>";
                echo "<iframe style='width: 70rem; height: inherit;' src='https://localhost//VidTube_organize_local/view/graphView.php' onload='resizeIframe(this)' frameborder='0'  scrolling='no'  ></iframe>";
            }
    ?>
<!--    <iframe src="https://localhost//VidTube_organize_local/view/graphView.php" frameborder="0" width="100%" height="100%" scrolling="no" onload="resizeIframe(this)" ></iframe>
-->
    </div>
 
   

    <div class="viewButton_analytics" style="margin-top: 2rem; margin-right:2rem;">
                    <a href="#">Select Image</a>

                </div>

   <!-- <div class="col-sm-5 imageSection" style=" display:none; margin-top:71px; height:390px; display:flex">
--> 
<div class="col-sm-5" style=" display:none; margin-top:71px; height:390px;">
       <!-- <div class="col-sm-12"> -->
...
document.querySelector(".viewButton_analytics").addEventListener("click", function(){
